...
(function ($) {
    ...
    breakpoints({
        default: ["1281px", null],
        wide: ["1141px", "1280px"],
        normal: ["1024px", "1141px"],
        narrow: ["896px", "1024px"],
        narrower: ["414px", "896px"],
        mobile: [null, "413px"]
    });
    ...
    switch (id) {
        ...
        case "landing":
            ...
            if (!browser.mobile && !$bar.hasClass("docked")) {
                ...
                $window.on("scroll", function () {
                    if (!$bar.hasClass("docked")) {
                        if ($window.scrollTop() > $items.offset().top - offset && !breakpoints.active("<=narrow")) {
                            $bar.addClass("docked");
            ...
            if (browser.mobile) $items.children("article").each(function () {
                var t = $(this);
            ...
            if (browser.os == "wp") $(".item .image").each(function () {
                var $t = $(this);
                $p = $t.children(".placeholder"), src = $p.data("src");
                $p.attr("src", src);
                $t.addClass("is-cached")
            });
            else $(".item .image").each(function () {
                var $t = $(this),
        ...
        case "demo":
            ...
            var website = document.wform.website.value;
            if (website == "") website = $_GET["q"]
            if (website === undefined) website = localStorage['bundle:q'] || "";
            if (website != "") $iframe.attr("src", website);
            ...
            $window.on("resize", function () {
                if ($selector.is(":visible")) {
                    if ($window.width() < 1200) {
                        ...
                        $selector.hide();
                        $iframeWrapper.css("left", 0).css("top", 1000).css("width", "100%").css("height", "100%").css("margin-top", $body.hasClass("overlap") ? 0 : "3.375em").css("margin-left", 0)
                    }
                } else {
            ...
            $selector_li.each(function () {
                ...
                var t = $(this),
                    ...
                    width0 = t.data("width"),
                    height0 = t.data("height"),
                    marginLeft, marginTop, demoHeaderHeight = $demoHeader.outerHeight(),
                ...
                if (!height) {
                    ...
                    marginTop = "";
                    height = ""
                    height0 = $window.height();
                } else {
                    top = 50 + demoHeaderHeight + "px";
                    marginTop = 0;
                    height0 = height;
                    height = height0 + "px";
                    framed = true
                ...
                var bodyheight = height0 + demoHeaderHeight + 150 + "px";
                var bodywidth = width0 + 150 + "px";

                if (format == t.data("name")) {
                    ...
                    $demoHeader.find("#format").html(width0 + "x" + height0);
                    $body.css("height", bodyheight);
                    $body.css("width", bodywidth);
                    $body.css("margin", "auto");

                    localStorage['bundle:f'] = format || "";
                    localStorage['bundle:q'] = website || "";

                    if (framed) $iframeWrapper.addClass("framed");
                    else $iframeWrapper.removeClass("framed");

                    $iframeWrapper.css("position", "relative");
                    $iframeWrapper.css("left", left).css("top", top).css("width", width).css("height", height).css("margin-top", marginTop).css("margin-left", marginLeft);
                ...
                t.click(function () {
                    ...
                    if (isLocked || t.hasClass("active") || t.hasClass("locked")) return false;
                    isLocked = true;
                    $selector_li.removeClass("active");
                    t.addClass("active");
                    $iframeWrapper.addClass("loading");
                    ...
                    var format = t.data("name"),
                        website = document.wform.website.value;

                    if (website == "") website = $_GET["q"]
                    if (website == "") website = localStorage['bundle:q'] || "";
                    var getvars = "?q=" + website + "&f=" + format;

                    var url = window.location.protocol + "//" + window.location.host + window.location.pathname + getvars;
                    document.getElementById('copy').href = url

                    localStorage['bundle:f'] = format || "";
                    localStorage['bundle:q'] = website || "";

                    if (t.data("name") === undefined) {
                        ...
                        $iframeWrapper.style = "";
                        $iframeWrapper.css("position", "absolute");
                        $iframeWrapper.css("left", left).css("top", top).css("width", "100%").css("height", height).css("margin-top", "0%").css("margin-left", "0%");
