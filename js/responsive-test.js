	...
	function frameload() { iframe_loaded = 1; }
	function isloaded() {
		if(!iframe_loaded)
			document.getElementById('demo-iframe').src = "https://responsive-test.glitchr.io/error.html";
	}
	  ...
	  var query = document.getElementById('copy').href
		...
		else url = "https://responsive-test.glitchr.io/default.html";
                list.push(url);
